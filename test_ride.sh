...
if [ "$1" = "audio" ]; then
    ...
    shift;
    AudioURI=http://localhost:8000/? Resources=./Resources/  go run Web/Server/Background/Ame/main.go Web/Server/Background/Ame/cleaners.go Web/Server/Background/Ame/workers.go -c Resources/configuration.json $@
fi
